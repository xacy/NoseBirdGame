...
public class Pipe extends Scrollable{
    ...
    public boolean collides(Nose nose) {
        if (position.x < nose.getX() + nose.getWidth()) {
            return (Intersector.overlaps(nose.getBoundingCircle(), barUp)
                    || Intersector.overlaps(nose.getBoundingCircle(), barDown)
                    || Intersector.overlaps(nose.getBoundingCircle(), skullUp) || Intersector
                        .overlaps(nose.getBoundingCircle(), skullDown));
        }
        return false;
    }
