...
public class GameRenderer {
	...
	public void render() {
        ...
        shapeRenderer.end();
        /*
         * 4. We Draw the filled circle
         */
        shapeRenderer.begin(ShapeType.Filled);
        shapeRenderer.setColor(163 / 255.0f, 73 / 255.0f, 164 / 255.0f, 1);
        shapeRenderer.circle(myWorld.getCirc().x, myWorld.getCirc().y, myWorld.getCirc().radius);
        shapeRenderer.end();
        shapeRenderer.begin(ShapeType.Line);
        shapeRenderer.setColor(255 / 255.0f, 109 / 255.0f, 120 / 255.0f, 1);
        shapeRenderer.circle(myWorld.getCirc().x, myWorld.getCirc().y, myWorld.getCirc().radius);
